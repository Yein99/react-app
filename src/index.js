...
//10. HTML 삽입
const weather = document.querySelector(".js-weather"); //8. API KEY 입력 : API 제공기업에서 API키를 통해 서버에 무리갈 만큼 요청하는지 확인

const API_KEY = "e3c812d64beef0b0dab70748d0dab252"; //3.변수 선언

const COORDS = 'coords'; //9. API 함수
...
function handleGeoSucces(position) {
  ...
  const coordsObj = {
    latitude,
    //객체의 변수 이름과 키의 이름을 갖게 하려면 키 값은 버리고 ,를 적어준다.
    longitude
  };
